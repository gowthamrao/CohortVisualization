...
# }
# conceptIds <- c(extractDistinctValue(data$person, genderConceptId),
#                extractDistinctValue(data$person, raceConceptId),
#                extractDistinctValue(data$person, ethnicityConceptId),
#                extractDistinctValue(data$conditionOccurrence, conditionConceptId),
#                extractDistinctValue(data$conditionOccurrence, conditionTypeConceptId),
#                extractDistinctValue(data$drugExposure, drugConceptId),
#                extractDistinctValue(data$drugExposure, drugTypeConceptId)
# ) %>%  unique()
